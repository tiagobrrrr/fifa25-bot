"""
Models do banco de dados FIFA25 Bot
Este arquivo deve ser importado DEPOIS de db ser criado em app.py
"""
from datetime import datetime

# db será importado do app.py quando necessário
# Usamos uma referência que será preenchida em runtime

def create_models(db):
    """
    Cria e retorna todos os models usando a instância db fornecida
    Deve ser chamado em app.py após criar o SQLAlchemy
    """
    ...
    # Retornar todos os models
    return Match, Tournament, Player, ScraperLog